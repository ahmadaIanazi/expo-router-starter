...
const data = [
  {
    type: 'Humlan P',
    imageUri: require('../xSetup/assets/example/urbanears_blue.png'),
  ...
  {
    type: 'Pampas',
    imageUri: require('../xSetup/assets/example/urbanears_pink.png'),
  ...
  {
    type: 'Humlan P',
    imageUri: require('../xSetup/assets/example/urbanears_grey.png'),
  ...
  {
    type: 'Humlan B',
    imageUri: require('../xSetup/assets/example/urbanears_mint.png'),
    heading: 'From Sweden',
...
export default function HeadphonesCarouselExample() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image style={styles.logo} source={require('../xSetup/assets/example/ue_black_logo.png')} />
      <Pagination
        scrollOffsetAnimatedValue={scrollOffsetAnimatedValue}
        positionAnimatedValue={positionAnimatedValue}
      />
